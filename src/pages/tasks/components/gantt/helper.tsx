...
export const prepareGanttData = (tasks: TaskSchema[]): GanttTask[] => {
  ...
  return tasks.map(task => {
    ...
    const endDate = task.due_date || new Date(startDate.getTime() + 7 * 24 * 60 * 60 * 1000); // Default to 1 week duration
    ...
    return {
      ...
      isDisabled: task.status === 'backlog', // Example: disable tasks in backlog
      styles: {
